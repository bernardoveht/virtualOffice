...
@Component({
  selector: 'app-orden-search',
  templateUrl: './orden-search.component.html',
  styleUrls: ['./orden-search.component.scss']
})
export class OrdenSearchComponent implements OnInit,OnDestroy {
